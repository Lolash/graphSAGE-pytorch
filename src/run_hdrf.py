...
from src.partition import partition_hdrf, evaluate_edge_partitioning
...
evaluate_edge_partitioning([e for s in partitions.values() for e in s], [p for p in partitions for _ in partitions[p]], "HDRF",
                           args.num_classes)
