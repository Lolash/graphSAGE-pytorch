        ...
        if dataSet == 'cora':
            ...
            with open(cora_cite_file) as fp:
                for i, line in enumerate(fp):
                    ...
                    if paper1 in train_indexs and paper2 in train_indexs:
                        adj_list_train[paper1].add(paper2)
                        adj_list_train[paper2].add(paper1)
                    if paper1 in test_indexs and paper2 in test_indexs:
                        adj_list_test[paper1].add(paper2)
                        adj_list_test[paper2].add(paper1)
                    if paper1 in val_indexs and paper2 in val_indexs:
                        adj_list_val[paper1].add(paper2)
                        adj_list_val[paper2].add(paper1)
